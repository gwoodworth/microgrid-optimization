function [x,iters] = phaseonetest(A,b)
% PHASEONETEST  Phaseone, but returns the number of iterations of
% sfsimplex.
% Compute an initial basic feasible solution (BFS) x0
...
newx = [zeros(n,1); b];
[xart, zart,iters] = sfsimplex(newc,newA,b,newx,false,1000);
if zart > 0.0
